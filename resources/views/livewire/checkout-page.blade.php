                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="first_name" type="text" wire:model='firstName'>
                                </input>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                    id="last_name" type="text" wire:model='lastName'>
                                </input>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <input
                                class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                id="phone" type="text" wire:model='phoneNumber'>
                            </input>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <div>
                                ...
                                <input
                                    class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                    id="state" type="text" wire:model='homeNumber'>
                                </input>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                    id="zip" type="text" wire:model='block'>
                                </input>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <input
                                class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none"
                                id="address" type="text" wire:model='streetAddress'>
                            </input>
                        </div>
                    </div>
